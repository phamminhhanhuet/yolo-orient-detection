...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default=ROOT / 'weights/last.pt', help='initial weights path')
    #parser.add_argument('--weights', type=str, default=ROOT / 'runs/train/exp26/weights/best.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'yolov5obb_test.yaml', help='dataset.yaml path')
