...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    print('Model: ', model.nc, model.hyp, model.class_weights, model.names)
...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default=ROOT / 'runs/train/exp39/weights/best.pt', help='initial weights path')
    #parser.add_argument('--weights', type=str, default=ROOT / 'runs/train/exp26/weights/best.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'yolov5obb_train.yaml', help='dataset.yaml path')
